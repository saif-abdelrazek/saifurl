  ...
  return (
    <div className="min-h-screen flex flex-col transition-colors duration-300 bg-gradient-to-br from-blue-100 via-white to-red-100 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900">
      ...
      <header className="flex justify-between items-center px-8 py-6 bg-white/80 shadow-md dark:bg-gray-800/80 dark:shadow-lg transition-colors duration-300">
        <Link to="/" className="text-3xl font-bold tracking-tight text-blue-700 dark:text-blue-300">
        ...
        <div className="flex items-center space-x-4">
          {isUserLoading ? (
            ...
            <>
              <SignoutBtn />
              <Link to="/dashboard" className="px-5 py-2 rounded-lg font-semibold transition bg-blue-600 text-white hover:bg-blue-700">Dashboard</Link>
            </>
          ) : (
            <>
              <Link to="/signin" className="px-5 py-2 rounded-lg font-semibold transition bg-blue-600 text-white hover:bg-blue-700">Login</Link>
              <Link to="/signup" className="px-5 py-2 rounded-lg font-semibold transition bg-red-500 text-white hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700">Signup</Link>
            </>
          )}
          {/* Theme Toggle */}
          <button
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        <div className="max-w-4xl w-full">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-extrabold mb-4 text-blue-800 dark:text-blue-200">
              SaifURL <span className="text-red-600 dark:text-red-400">Bots</span>
            </h1>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            ...
            <div className="backdrop-blur-sm rounded-2xl shadow-lg p-8 border bg-white/80 border-white/20 dark:bg-gray-800/80 dark:border-gray-700/20">
              <div className="text-center">
                ...
                <div className="space-y-3">
                  <a
                    ...
                    className="block w-full py-3 px-6 rounded-lg font-semibold transition duration-200 text-center bg-blue-600 text-white hover:bg-blue-700"
                  >
                    Start Bot
                  </a>
            ...
            <div className="backdrop-blur-sm rounded-2xl shadow-lg p-8 border opacity-75 bg-white/60 border-white/20 dark:bg-gray-800/60 dark:border-gray-700/20">
              <div className="text-center">
          ...
          <div className="backdrop-blur-sm rounded-2xl shadow-xl p-8 border mb-8 bg-white/80 border-white/20 dark:bg-gray-800/80 dark:border-gray-700/20">
            <h2 className="text-2xl font-bold mb-6 text-center text-gray-800 dark:text-gray-100">
              How to Use SaifURL Telegram Bot
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 bg-blue-100 dark:bg-blue-900/50">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="backdrop-blur-sm rounded-2xl shadow-xl p-6 border bg-white/80 border-white/20 dark:bg-gray-800/80 dark:border-gray-700/20">
          ...
          <div className="mt-8 backdrop-blur-sm rounded-2xl shadow-xl p-6 border text-center bg-green-50/80 border-green-200/50 dark:bg-green-900/30 dark:border-green-700/50">
